...
public class Info {
	...
	public void maskprop(String uid, java.util.List groups, String myself) {if (category!=null) {boolean ex=false;if (groups==null) groups = new java.util.ArrayList();java.util.ArrayList groups2 = new java.util.ArrayList(groups);groups2.add(""+uid);for(int i=0;i<groups2.size();i++) {java.util.regex.Pattern p = java.util.regex.Pattern.compile("^/@[^/]*/@testservice/1/group/office$|^/@testservice/1/group/office$");java.util.regex.Matcher m = p.matcher(""+groups2.get(i));if (m.find()) ex=true;}if (!ex) category=null;}};
